...
This repository has 4 directories, “Release”, “Codes”, “DataAnalysis” and “BlockDiagram”. “[*Release*](https://github.com/wbap/WBCA/tree/master/Release)” directory includes the current version of WBCA (wbca_version.json), which is the main product described in [BriCA Language](https://wba-initiative.org/wiki/en/brica_language),. “[*Codes*](https://github.com/wbap/WBCA/tree/master/Codes)” has all algorithms we developed for data analysis and representation. “[*DataAnalysis*](https://github.com/wbap/WBCA/tree/master/DataAnalysis)” consists of original raw data from Allen Institute for Brain Science, and analytical results processed by our algorithms. BlockDiagram has input and output files for mermaid.js (written by JavaScript) to illustrate a block diagram of the whole brain architecture.
